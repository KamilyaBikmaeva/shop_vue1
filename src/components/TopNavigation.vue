<template>
    <nav>
      ...
      <router-link to="/belts">Ремни</router-link>
      <router-link to="/rings">Кольца</router-link>
      <div class="nav-link">
...
<style lang="css">
nav {
  box-shadow: 1px 0rem 14px 0px rgb(216, 214, 214);
  width: 100%;
  padding: 24px;
  position: fixed;
  height: 66px;
  background-color:rgb(191, 241, 229);
  z-index: 99;
}
